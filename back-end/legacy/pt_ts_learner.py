...
class PtTsLearner(BaseLearner):
    def __init__(self,
                 ...
                 train_writer_p="../data/ts_runs/pt_ts_train",
                 val_writer_p="../data/ts_runs/pt_ts_val"
                 ):
        super().__init__()
        self.create_logger(log_path="PtTsLearner.log")
    ...
    def fit(self,
        ...
        if mode == "rgb":
            ...
            ts = models.resnet101(pretrained=True)
            self.load(ts, "../data/pretrained_models/ts_motion_pt.pickle")
            p_vid = p_vid + "pt-flow/"
