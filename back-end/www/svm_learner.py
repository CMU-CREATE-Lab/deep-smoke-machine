...
class SvmLearner(BaseLearner):
    ...
    def fit(self,
            save_model_path="../data/saved_svm/[model_id]/model/",
            save_tensorboard_path="../data/saved_svm/[model_id]/run/",
            save_log_path="../data/saved_svm/[model_id]/log/train.log"
            ):
        ...
        for phase in ["train", "validation"]:
            ...
            for d in dataloader[phase]:
                ...
                #writer.add_image("true_0_pred_0", prfs[0], global_step=steps)
    ...
    def predict(self,
            p_model=None,
            save_log_path="../data/saved_svm/test.log"
            ):
