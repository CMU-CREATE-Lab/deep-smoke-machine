...
from model.tsm.ops.basic_ops import ConsensusModule
from model.tsm.ops.transforms import *
...
class TSN(nn.Module):
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            if self.is_shift:
                ...
                from model.tsm.ops.temporal_shift import make_temporal_shift
                make_temporal_shift(self.base_model, self.num_segments,
                                    n_div=self.shift_div, place=self.shift_place, temporal_pool=self.temporal_pool)

            if self.non_local:
                print('Adding non-local module...')
                from model.tsm.ops.non_local import make_non_local
            ...
            from model.tsm.archs.mobilenet_v2 import mobilenet_v2, InvertedResidual
            ...
            from model.tsm.archs.bn_inception import bninception
    ...
    def train(self, mode=True):
        ...
        # Do not freeze BN like the original paper since we are using this for a different application
        """
        count = 0
    ...
    def replace_logits(self, c):
        # No need to implement this function
        # The purpose of this function is to prevent errors
        pass
