# deep-smoke-machine
Deep learning models and dataset for recognizing industrial smoke emissions. The videos are from the [smoke labeling tool](https://github.com/CMU-CREATE-Lab/video-labeling-tool). The code in this repository assumes that Ubuntu 18.04 server is installed.
...
```
For others who wish to use the publicly released dataset (a snapshot of the system on 2/24/2020), we aleady include metadata_02242020.json file under the deep-smoke-machine/back-end/data/ folder. You need to rename this file to metadata.json.
```sh
